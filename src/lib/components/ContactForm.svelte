...
<div
	class="container flex flex-col gap-2 justify-center items-baseline sm:flex-row sm:justify-between mt-16 lg:mt-24 mb-10 sm:px-16"
>
...
>
	<form method="POST" action="/formSubmit?/contact" data-sveltekit-keepfocus>
